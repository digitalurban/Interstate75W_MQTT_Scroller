...
# Brightness settings
brightness = 30  # Initial brightness (0 to 100)
...
def sub_cb(topic, msg, retained):
    ...
    while True:
        ...
        draw_text_with_outline_multiline(message_lines, x=BUFFER_PIXELS + 1, y=height - scroll + BUFFER_PIXELS, scale=1, text_color=white, outline_color=black)
